        ...
        <div className="p-6 border-b border-border bg-card">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-foreground tracking-tight">Scraper de Farmacias</h2>
                <p className="text-sm text-muted-foreground">Extrae Vademécums enteros desde una URL</p>
              </div>
            </div>
          ...
          <div className="flex gap-3">
            ...
            {!isRunning ? (
              <button
                ...
                disabled={!targetUrl}
                className="px-6 py-3 bg-primary hover:bg-orange-500 text-foreground rounded-xl font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
              ...
              <button
                ...
                className="px-6 py-3 bg-rose-500 hover:bg-rose-600 text-foreground rounded-xl font-bold transition-all flex items-center gap-2"
              >
