...
/** Reinicia el contador de fallos (llamado tras un éxito o al forzar sync). */
...
/** Fuerza la replicación de productos ignorando el contador de fallos.
 *  Llamado por el botón "Sincronizar ahora" en Settings para reintentar
 *  tras fallos previos. Reinicia el contador antes de replicar. */
