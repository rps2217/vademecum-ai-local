...
export const KNOWLEDGE_BASE_EXPANDED: Record<string, IngredientInfo> = {
  ...
  // ==================== HONGOS MEDICINALES ====================
  'reishi': createIngredient('reishi', 'Reishi (Ganoderma lucidum)', 'hongos',
    'Hongo medicinal chino con propiedades inmunomoduladoras.',
    'Beta-glucanos activan células inmunes, triterpenos antiinflamatorios.',
    ['Inmunidad', 'Antioxidante', 'Antiinflamatorio', 'Bienestar general'],
    ['inmunidad', 'antioxidante'],
    [
      { id: 'shiitake', tipo: 'complementario', desc: 'Combinación de hongos', nivel: 'alto' },
      { id: 'cordyceps', tipo: 'complementario', desc: 'Apoyo energético', nivel: 'medio' }
    ],
    { dosis: '1.5-9g/día' }
  ),

  'shiitake': createIngredient('shiitake', 'Shiitake (Lentinula edodes)', 'hongos',
    'Hongo comestible con propiedades inmunoestimulantes.',
    'Lentinan activa macrófagos y células NK.',
    ['Inmunidad', 'Antiviral', 'Anticancerígeno'],
    ['inmunidad'],
    [
      { id: 'reishi', tipo: 'complementario', desc: 'Combinación de hongos', nivel: 'alto' },
      { id: 'vitamina_c', tipo: 'potenciador', desc: 'Mejora absorción', nivel: 'medio' }
    ],
    { dosis: '9-27g/día' }
  ),

  'cordyceps': createIngredient('cordyceps', 'Cordyceps (Cordyceps sinensis)', 'hongos',
    'Hongo parasitario con propiedades energizantes.',
    'Aumenta producción de ATP, mejora utilización de oxígeno.',
    ['Energía', 'Rendimiento físico', 'Función renal'],
    ['energia', 'rendimiento'],
    [
      { id: 'coenzima_q10', tipo: 'potenciador', desc: 'Producción de energía celular', nivel: 'alto' },
      { id: 'ginseng', tipo: 'complementario', desc: 'Energía adaptógena', nivel: 'medio' }
    ],
    { dosis: '1-3g/día' }
  ),

  'maitake': createIngredient('maitake', 'Maitake (Grifola frondosa)', 'hongos',
    'Hongo con propiedades anticancerígenas.',
    'Beta-glucanos D-fracción activan sistema inmune.',
    ['Inmunidad', 'Anticancerígeno', 'Antioxidante'],
    ['inmunidad'],
    [
      { id: 'reishi', tipo: 'complementario', desc: 'Combinación de hongos', nivel: 'alto' },
      { id: 'vitamina_d3', tipo: 'potenciador', desc: 'Apoyo inmunitario', nivel: 'medio' }
    ],
    { dosis: '3-7g/día' }
  ),

  // ==================== PLANTAS MEDICINALES ====================
  'ashwagandha': createIngredient('ashwagandha', 'Ashwagandha (Withania somnifera)', 'plantas',
    'Planta adaptógena india para estrés y ansiedad.',
    'Withanólidos modulan cortisol, receptores GABA.',
    ['Estrés', 'Ansiedad', 'Sueño', 'Energía'],
    ['estres', 'ansiedad', 'sueno'],
    [
      { id: 'rodiola', tipo: 'complementario', desc: 'Adaptógenos juntos', nivel: 'alto' },
      { id: 'magnesio', tipo: 'potenciador', desc: 'Relajación muscular', nivel: 'medio' }
    ],
    { dosis: '300-600mg/día', contraindicaciones: [
      { condicion: 'embarazo', nivel: 'contraindicado', desc: 'No usar en embarazo' }
    ]}
  ),

  'rodiola': createIngredient('rodiola', 'Rodiola (Rhodiola rosea)', 'plantas',
    'Planta adaptógena para fatiga y función cognitiva.',
    'Rosavinas y salidrósido, moduladores de serotonina.',
    ['Fatiga', 'Cognición', 'Estrés', 'Rendimiento'],
    ['energia', 'cerebro', 'estres'],
    [
      { id: 'ashwagandha', tipo: 'complementario', desc: 'Adaptógenos juntos', nivel: 'alto' },
      { id: 'ginkgo', tipo: 'potenciador', desc: 'Circulación cerebral', nivel: 'medio' }
    ],
    { dosis: '200-600mg/día' }
  ),

  'ginkgo': createIngredient('ginkgo', 'Ginkgo biloba', 'plantas',
    'Planta para circulación y función cognitiva.',
    'Flavonoides y terpenoides, vasodilatador cerebral.',
    ['Memoria', 'Circulación', 'Función cognitiva'],
    ['cerebro', 'memoria'],
    [
      { id: 'vinpocetina', tipo: 'potenciador', desc: 'Circulación cerebral', nivel: 'alto' },
      { id: 'omega_3', tipo: 'complementario', desc: 'Neuroprotección', nivel: 'alto' }
    ],
    { dosis: '120-240mg/día', contraindicaciones: [
      { condicion: 'anticoagulantes', nivel: 'precaución', desc: 'Puede aumentar sangrado' }
    ]}
  ),

  'valeriana': createIngredient('valeriana', 'Valeriana (Valeriana officinalis)', 'plantas',
    'Planta sedante natural para insomnio.',
    'Ácidos valérico y valerenico, moduladores GABA.',
    ['Insomnio', 'Ansiedad', 'Relajación'],
    ['sueno', 'ansiedad'],
    [
      { id: 'melatonina', tipo: 'potenciador', desc: 'Sueño mejorado', nivel: 'alto' },
      { id: 'magnesio', tipo: 'complementario', desc: 'Relajación', nivel: 'medio' }
    ],
    { dosis: '300-600mg/día' }
  ),

  'pasiflora': createIngredient('pasiflora', 'Pasiflora (Passiflora incarnata)', 'plantas',
    'Planta para ansiedad e insomnio.',
    'Flavonoides y alcaloides, moduladores GABA.',
    ['Ansiedad', 'Insomnio', 'Relajación'],
    ['ansiedad', 'sueno'],
    [
      { id: 'valeriana', tipo: 'potenciador', desc: 'Sedantes juntos', nivel: 'alto' },
      { id: 'lavanda', tipo: 'complementario', desc: 'Relajación aromática', nivel: 'medio' }
    ],
    { dosis: '200-400mg/día' }
  ),

  'lavanda': createIngredient('lavanda', 'Lavanda (Lavandula)', 'plantas',
    'Planta aromática para relajación y ansiedad.',
    'Linalool y linalil acetato, moduladores nerviosos.',
    ['Ansiedad', 'Estrés', 'Insomnio'],
    ['estres', 'sueno'],
    [
      { id: 'pasiflora', tipo: 'complementario', desc: 'Relajación combinada', nivel: 'medio' },
      { id: 'melatonina', tipo: 'potenciador', desc: 'Sueño mejorado', nivel: 'medio' }
    ],
    { dosis: '80-160mg/día' }
  ),

  'curcuma': createIngredient('curcuma', 'Cúrcuma (Curcuma longa)', 'plantas',
    'Especia antiinflamatoria y antioxidante.',
    'Curcumina inhibe NF-κB, poderoso antioxidante.',
    ['Antiinflamatorio', 'Antioxidante', 'Articulaciones', 'Digestión'],
    ['antiinflamatorio', 'articulaciones'],
    [
      { id: 'pimienta_negra', tipo: 'potenciador', desc: 'Piperina aumenta absorción 2000%', nivel: 'alto' },
      { id: 'jengibrel', tipo: 'complementario', desc: 'Antiinflamatorio synerg', nivel: 'alto' }
    ],
    { dosis: '500-2000mg/día' }
  ),

  'jengibrel': createIngredient('jengibrel', 'Jengibre (Zingiber officinale)', 'plantas',
    'Raíz antiinflamatoria y digestiva.',
    'Gingeroles, antiemético y antiinflamatorio.',
    ['Digestión', 'Antiinflamatorio', 'Náuseas', 'Articulaciones'],
    ['digestion', 'antiinflamatorio'],
    [
      { id: 'curcuma', tipo: 'potenciador', desc: 'Antiinflamatorio synerg', nivel: 'alto' },
      { id: 'pimienta_negra', tipo: 'potenciador', desc: 'Mejora absorción', nivel: 'alto' }
    ],
    { dosis: '1-3g/día' }
  ),

  'pimienta_negra': createIngredient('pimienta_negra', 'Pimienta Negra (Piper nigrum)', 'plantas',
    'Potenciador de biodisponibilidad.',
    'Piperina inhibe enzimas hepáticas, aumenta absorción.',
    ['Absorción', 'Potenciador'],
    ['digestion'],
    [
      { id: 'curcuma', tipo: 'potenciador', desc: 'Aumenta curcumina 2000%', nivel: 'alto' },
      { id: 'resveratrol', tipo: 'potenciador', desc: 'Mejora absorción', nivel: 'alto' }
    ],
    { dosis: '5-20mg/día' }
  ),

  'tecomahaca': createIngredient('tecomahaca', 'Tecoma tahaca (Tecoma stans)', 'plantas',
    'Planta medicinal para diabetes y digestión.',
    'Hipoglicemiante natural, digestivo.',
    ['Diabetes', 'Digestión', 'Antiinflamatorio'],
    ['metabolismo', 'digestion'],
    [
      { id: 'canela', tipo: 'complementario', desc: 'Control de glucosa', nivel: 'alto' },
      { id: 'curcuma', tipo: 'complementario', desc: 'Antiinflamatorio', nivel: 'medio' }
    ],
  ...
  'maca': createIngredient('maca', 'Maca (Lepidium meyenii)', 'plantas',
    'Planta andina para energía y libido.',
    'Adaptógeno, balance hormonal, energía.',
    ['Energía', 'Libido', 'Equilibrio hormonal'],
    ['energia', 'hormonal'],
    [
      { id: 'ginseng', tipo: 'complementario', desc: 'Energía adaptógena', nivel: 'alto' },
      { id: 'ashwagandha', tipo: 'complementario', desc: 'Balance hormonal', nivel: 'medio' }
    ],
    { dosis: '1.5-3g/día' }
  ),

  'ginseng_panamax': createIngredient('ginseng_panamax', 'Ginseng Panamax (Panax ginseng)', 'plantas',
    'Ginseng coreano para energía y cognición.',
    'Ginsenósidos, adaptógeno, estimulante cognitivo.',
    ['Energía', 'Cognición', 'Estrés', 'Inmunidad'],
    ['energia', 'cerebro', 'inmunidad'],
    [
      { id: 'ginkgo', tipo: 'potenciador', desc: 'Cognición mejorada', nivel: 'alto' },
      { id: 'coenzima_q10', tipo: 'complementario', desc: 'Energía celular', nivel: 'medio' }
    ],
    { dosis: '200-400mg/día' }
  ),

  'hierba_de_san_juan': createIngredient('hierba_de_san_juan', 'Hierba de San Juan (Hypericum)', 'plantas',
    'Planta para depresión leve y moderada.',
    'Hipericina e hiperforina, inhibidores de recaptación de serotonina.',
    ['Depresión', 'Ansiedad', 'Bienestar emocional'],
    ['cerebro', 'estabilizador'],
    [
      { id: '5htp', tipo: 'complementario', desc: 'Precursor de serotonina', nivel: 'alto' },
      { id: 'omega_3', tipo: 'potenciador', desc: 'Neuroprotección', nivel: 'alto' }
    ],
    { dosis: '300-900mg/día', contraindicaciones: [
      { condicion: 'antidepresivos', nivel: 'contraindicado', desc: 'Interacciones graves' }
    ]}
  ),

  'sauzgatillo': createIngredient('sauzgatillo', 'Sauzgatillo (Vitex agnus-castus)', 'plantas',
    'Planta para síndrome premenstrual.',
    'Dopaminérgico, modulador prolactina.',
    ['Síndrome premenstrual', 'Equilibrio hormonal', 'Ciclo menstrual'],
    ['hormonal', 'femenino'],
    [
      { id: 'magnesio', tipo: 'potenciador', desc: 'Alivia SPM', nivel: 'medio' },
      { id: 'vitamina_b6', tipo: 'complementario', desc: 'Metabolismo hormonal', nivel: 'medio' }
    ],
    { dosis: '400-800mg/día' }
  ),

  'cimicifuga': createIngredient('cimicifuga', 'Cimicífuga (Cimicifuga racemosa)', 'plantas',
    'Planta para síntomas de menopausia.',
    'Fitoestrógenos, alivio de sofocos.',
    ['Menopausia', 'Sofocos', 'Equilibrio hormonal'],
    ['hormonal', 'femenino'],
    [
      { id: 'sauzgatillo', tipo: 'complementario', desc: 'Balance hormonal', nivel: 'medio' },
      { id: 'soya', tipo: 'potenciador', desc: 'Isoflavonas', nivel: 'medio' }
    ],
    { dosis: '20-80mg/día' }
  ),

  'yacon': createIngredient('yacon', 'Yacón (Smallanthus sonchifolius)', 'plantas',
    'Raíz prebiótica para diabetes y digestión.',
    'Fructooligosacáridos, reguladores de glucosa.',
    ['Prebiótico', 'Diabetes', 'Flora intestinal'],
    ['digestion', 'metabolismo'],
    [
      { id: 'inulina', tipo: 'complementario', desc: 'Prebióticos juntos', nivel: 'alto' },
      { id: 'probioticos', tipo: 'potenciador', desc: 'Synbiotics', nivel: 'alto' }
    ],
    { dosis: '5-10g/día' }
  ),

  'estevia': createIngredient('estevia', 'Estevia (Stevia rebaudiana)', 'plantas',
    'Edulcorante natural sin calorías.',
    'Glucósidos de esteviol, edulcorante natural.',
    ['Endulzante', 'Control de peso', 'Diabetes'],
    ['metabolismo'],
    [
      { id: 'canela', tipo: 'complementario', desc: 'Control de glucosa', nivel: 'medio' }
    ],
    { dosis: '200-500mg/día' }
  ),

  'aceite_de_persea': createIngredient('aceite_de_persea', 'Aceite de Persea (Palta)', 'plantas',
    'Aceite de palta con grasas saludables.',
    'Ácido oleico, vitaminas liposolubles.',
    ['Salud cardiovascular', 'Nutrición', 'Antioxidante'],
    ['corazon', 'antioxidante'],
    [
      { id: 'omega_3', tipo: 'complementario', desc: 'Grasas saludables', nivel: 'alto' },
      { id: 'vitamina_e', tipo: 'potenciador', desc: 'Antioxidante liposoluble', nivel: 'medio' }
    ],
    { dosis: '10-30ml/día' }
  ),

  'aceituna': createIngredient('aceituna', 'Olivo (Olea europaea)', 'plantas',
    'Fuente de polifenoles y ácido oleico.',
    'Oleuropeína, antioxidante y antiinflamatorio.',
    ['Antioxidante', 'Presión arterial', 'Corazón'],
    ['corazon', 'antioxidante'],
    [
      { id: 'omega_3', tipo: 'complementario', desc: 'Salud cardiovascular', nivel: 'alto' },
      { id: 'coenzima_q10', tipo: 'complementario', desc: 'Función cardíaca', nivel: 'medio' }
    ],
    { dosis: '20-50ml/día' }
  ),
  ...
  // ==================== ENZIMAS ====================
  'serrapeptasa': createIngredient('serrapeptasa', 'Serrapeptasa', 'enzimas',
    'Enzima proteolítica para inflamación.',
    'Digiere proteínas muertas, reduce edema.',
    ['Antiinflamatorio', 'Articulaciones', 'Circulación'],
    ['antiinflamatorio', 'articula'],
    [
      { id: 'bromelaina', tipo: 'potenciador', desc: 'Enzimas antiinflamatorias', nivel: 'alto' },
      { id: 'curcuma', tipo: 'complementario', desc: 'Antiinflamatorio natural', nivel: 'alto' }
    ],
    { dosis: '10-60mg/día' }
  ),

  'bromelaina': createIngredient('bromelaina', 'Bromelina', 'enzimas',
    'Enzima de piña con propiedades antiinflamatorias.',
    'Proteasa de tallo de piña, reduce inflamación.',
    ['Antiinflamatorio', 'Digestión', 'Articulaciones'],
    ['antiinflamatorio', 'articula', 'digestion'],
    [
      { id: 'serrapeptasa', tipo: 'potenciador', desc: 'Enzimas antiinflamatorias', nivel: 'alto' },
      { id: 'curcuma', tipo: 'complementario', desc: 'Antiinflamatorio synerg', nivel: 'alto' }
    ],
    { dosis: '500-2000mg/día' }
  ),

  'papaina': createIngredient('papaina', 'Papaína', 'enzimas',
    'Enzima proteolítica de papaya.',
    'Digestión de proteínas, antiinflamatorio.',
    ['Digestión', 'Antiinflamatorio'],
    ['digestion', 'antiinflamatorio'],
    [
      { id: 'bromelaina', tipo: 'potenciador', desc: 'Enzimas digestivas', nivel: 'medio' },
      { id: 'probioticos', tipo: 'complementario', desc: 'Apoyo digestivo', nivel: 'medio' }
    ],
    { dosis: '500-1000mg/día' }
  ),

  // ==================== AMINOÁCIDOS ====================
  'gaba': createIngredient('gaba', 'GABA (Ácido Gamma-Aminobutírico)', 'aminoacidos',
    'Neurotransmisor inhibidor para calma.',
    'Receptor GABA-A, reduce excitabilidad neuronal.',
    ['Ansiedad', 'Sueño', 'Relajación'],
    ['sueno', 'ansiedad'],
    [
      { id: 'l-teanina', tipo: 'potenciador', desc: 'Relajación sin somnolencia', nivel: 'alto' },
      { id: 'magnesio', tipo: 'potenciador', desc: 'Receptor GABA', nivel: 'alto' }
    ],
    { dosis: '250-750mg/día' }
  ),

  'l-teanina': createIngredient('l-teanina', 'L-Teanina', 'aminoacidos',
    'Aminoácido del té para relajación.',
    'Aumenta GABA, serotonina y dopamina.',
    ['Estrés', 'Foco', 'Relajación', 'Sueño'],
    ['cerebro', 'estres'],
    [
      { id: 'gaba', tipo: 'potenciador', desc: 'Receptores GABA', nivel: 'alto' },
      { id: 'cafeina', tipo: 'moderador', desc: 'Foco sin nerviosismo', nivel: 'alto' }
    ],
    { dosis: '100-400mg/día' }
  ),

  '5htp': createIngredient('5htp', '5-HTP (5-Hydroxitriptófano)', 'aminoacidos',
    'Precursor de serotonina para bienestar.',
    'Cruza barrera hematoencefálica, aumenta serotonina.',
    ['Depresión', 'Ansiedad', 'Apetito'],
    ['cerebro', 'estabilizador'],
    [
      { id: 'vitamina_b6', tipo: 'cofactor', desc: 'Conversión a serotonina', nivel: 'alto' },
      { id: 'gaba', tipo: 'complementario', desc: 'Bienestar emocional', nivel: 'medio' }
    ],
    { dosis: '50-300mg/día', contraindicaciones: [
      { condicion: 'antidepresivos', nivel: 'precaución', desc: 'Consultar médico' }
    ]}
  ),

  'nac': createIngredient('nac', 'NAC (N-Acetil Cisteína)', 'aminoacidos',
    'Antioxidante y precursor de glutatión.',
    'Precursor directo de glutatión, mucolítico.',
    ['Antioxidante', 'Hígado', 'Respiratorio', 'Fertilidad'],
    ['antioxidante', 'detox'],
    [
      { id: 'selenio', tipo: 'cofactor', desc: 'Producción de glutatión', nivel: 'alto' },
      { id: 'vitamina_c', tipo: 'potenciador', desc: 'Regenera glutatión', nivel: 'alto' }
    ],
    { dosis: '600-1800mg/día' }
  ),

  'glicina': createIngredient('glicina', 'Glicina', 'aminoacidos',
    'Aminoácido para sueño y articulaciones.',
    'Neurotransmisor inhibitorio, componente de colágeno.',
    ['Sueño', 'Colágeno', 'Cognición'],
    ['sueno', 'articula'],
    [
      { id: 'magnesio', tipo: 'potenciador', desc: 'Sueño mejorado', nivel: 'alto' },
      { id: 'colageno', tipo: 'complementario', desc: 'Componente de colágeno', nivel: 'alto' }
    ],
    { dosis: '3-5g/día' }
  ),

  'taurina': createIngredient('taurina', 'Taurina', 'aminoacidos',
    'Aminoácido para corazón y rendimiento.',
    'Regulación cardíaca, antioxidante.',
    ['Corazón', 'Rendimiento', 'Electrolitos'],
    ['corazon', 'energia'],
    [
      { id: 'magnesio', tipo: 'potenciador', desc: 'Electrolitos', nivel: 'alto' },
      { id: 'coenzima_q10', tipo: 'complementario', desc: 'Función cardíaca', nivel: 'medio' }
    ],
    { dosis: '500-2000mg/día' }
  ),

  'l-carnitina': createIngredient('l-carnitina', 'L-Carnitina', 'aminoacidos',
    'Transportador de ácidos grasos.',
    'Moviliza grasas a mitocondrias.',
    ['Energía', 'Metabolismo', 'Rendimiento'],
    ['energia', 'metabolismo'],
    [
      { id: 'coenzima_q10', tipo: 'potenciador', desc: 'Producción de ATP', nivel: 'alto' },
      { id: 'ala', tipo: 'complementario', desc: 'Metabolismo', nivel: 'medio' }
    ],
    { dosis: '500-2000mg/día' }
  ),
  ...
  'boro': createIngredient('boro', 'Boro', 'minerales',
    'Mineral para huesos y hormonas.',
    'Metabolismo de calcio, magnesio y vitamina D.',
    ['Huesos', 'Hormonas', 'Cognición'],
    ['huesos', 'hormonal'],
    [
      { id: 'vitamina_d3', tipo: 'potenciador', desc: 'Metabolismo del calcio', nivel: 'alto' },
      { id: 'magnesio', tipo: 'complementario', desc: 'Absorción', nivel: 'medio' }
    ],
    { dosis: '3-5mg/día' }
  ),

  'silicio': createIngredient('silicio', 'Silicio (Coloidal)', 'minerales',
    'Mineral para piel, cabello y uñas.',
    'Componente de colágeno, elastina.',
    ['Piel', 'Cabello', 'Uñas', 'Huesos'],
    ['piel', 'belleza'],
    [
      { id: 'colageno', tipo: 'potenciador', desc: 'Síntesis de colágeno', nivel: 'alto' },
      { id: 'vitamina_c', tipo: 'cofactor', desc: 'Producción de colágeno', nivel: 'alto' }
    ],
    { dosis: '10-30mg/día' }
  ),

  'molibdeno': createIngredient('molibdeno', 'Molibdeno', 'minerales',
    'Mineral traza para detoxificación.',
    'Cofactor de enzimas detoxificadoras.',
    ['Detox', 'Metabolismo', 'Hígado'],
    ['detox', 'metabolismo'],
    [
      { id: 'nac', tipo: 'potenciador', desc: 'Detoxificación', nivel: 'alto' },
      { id: 'magnesio', tipo: 'complementario', desc: 'Enzimas', nivel: 'medio' }
    ],
    { dosis: '50-100mcg/día' }
  ),
  ...
  'berberina': createIngredient('berberina', 'Berberina', 'extractos',
    'Alcaloide para control de glucosa y lípidos.',
    'Activa AMPK, reduce glucosa y colesterol.',
    ['Diabetes', 'Colesterol', 'Microbiota'],
    ['metabolismo', 'corazon'],
    [
      { id: 'canela', tipo: 'potenciador', desc: 'Control de glucosa', nivel: 'alto' },
      { id: 'probióticos', tipo: 'complementario', desc: 'Salud intestinal', nivel: 'alto' }
    ],
  ...
  'picolinato_de_cromo': createIngredient('picolinato_de_cromo', 'Picolinato de Cromo', 'minerales',
    'Mineral para metabolismo de glucosa.',
    'Potencia insulina, metabolismo de carbohidratos.',
    ['Glucosa', 'Metabolismo', 'Apetito'],
    ['metabolismo'],
    [
      { id: 'berberina', tipo: 'potenciador', desc: 'Control de glucosa', nivel: 'alto' },
      { id: 'canela', tipo: 'complementario', desc: 'Sensibilidad a insulina', nivel: 'alto' }
    ],
    { dosis: '200-1000mcg/día' }
  ),

  'alfa_lipoico': createIngredient('alfa_lipoico', 'Ácido Alfa Lipoico (ALA)', 'antioxidantes',
    'Antioxidante universal e hidrosoluble.',
    'Regenera otros antioxidantes, sensibiliza insulina.',
    ['Antioxidante', 'Diabetes', 'Hígado'],
    ['antioxidante', 'metabolismo'],
    [
      { id: 'biotina', tipo: 'moderador', desc: 'Compite por absorción', nivel: 'bajo' },
      { id: 'vitamina_b1', tipo: 'cofactor', desc: 'Metabolismo energético', nivel: 'medio' }
    ],
    { dosis: '300-600mg/día' }
  ),

  'coenzima_q10': createIngredient('coenzima_q10', 'Coenzima Q10', 'antioxidantes',
    'Antioxidante celular para energía cardíaca.',
    'Cadena respiratoria mitocondrial, producción de ATP.',
    ['Corazón', 'Energía', 'Antioxidante', 'Envejecimiento'],
    ['corazon', 'energia'],
    [
      { id: 'omega_3', tipo: 'potenciador', desc: 'Salud cardiovascular', nivel: 'alto' },
      { id: 'magnesio', tipo: 'complementario', desc: 'Producción de energía', nivel: 'alto' }
    ],
    { dosis: '100-300mg/día' }
  ),

  'resveratrol': createIngredient('resveratrol', 'Resveratrol', 'antioxidantes',
    'Polifenol del vino tinto para longevidad.',
    'Activador de sirtuinas, antioxidante.',
    ['Longevidad', 'Corazón', 'Antiinflamatorio'],
    ['antioxidante', 'longevidad'],
    [
      { id: 'pimienta_negra', tipo: 'potenciador', desc: 'Absorción mejorada', nivel: 'alto' },
      { id: 'quercetina', tipo: 'potenciador', desc: 'Sinergia flavonoide', nivel: 'alto' }
    ],
    { dosis: '150-500mg/día' }
  ),

  'pterostilbene': createIngredient('pterostilbene', 'Pterostilbeno', 'antioxidantes',
    'Análogo del resveratrol con mejor absorción.',
    'Similar a resveratrol, mayor biodisponibilidad.',
    ['Longevidad', 'Glucosa', 'Cognición'],
    ['longevidad', 'cerebro'],
    [
      { id: 'resveratrol', tipo: 'potenciador', desc: 'Mecanismos similares', nivel: 'alto' },
      { id: 'curcuma', tipo: 'complementario', desc: 'Antiinflamatorio', nivel: 'medio' }
    ],
    { dosis: '50-200mg/día' }
  ),

  'quercetina': createIngredient('quercetina', 'Quercetina', 'antioxidantes',
    'Flavonoide con propiedades antiinflamatorias.',
    'Estabiliza mastocitos, antioxidante potente.',
    ['Alergias', 'Antiinflamatorio', 'Inmunidad'],
    ['inmunidad', 'antiinflamatorio'],
    [
      { id: 'vitamina_c', tipo: 'potenciador', desc: 'Sinergia antioxidante', nivel: 'alto' },
      { id: 'bromelaina', tipo: 'potenciador', desc: 'Absorción mejorada', nivel: 'alto' }
    ],
    { dosis: '500-1000mg/día' }
  ),

  'astaxantina': createIngredient('astaxantina', 'Astaxantina', 'antioxidantes',
    'Carotenoide del krill para piel y articulaciones.',
    'Antioxidante 6000x más potente que vitamina C.',
    ['Piel', 'Articulaciones', 'Antioxidante', 'Ojos'],
    ['piel', 'articula'],
    [
      { id: 'omega_3', tipo: 'potenciador', desc: 'Salud cardiovascular', nivel: 'alto' },
      { id: 'luteina', tipo: 'complementario', desc: 'Protección ocular', nivel: 'medio' }
    ],
    { dosis: '4-12mg/día' }
  ),

  'sulforafano': createIngredient('sulforafano', 'Sulforafano', 'extractos',
    'Isotiocianato del brócoli para detox.',
    'Activador Nrf2, aumenta glutatión.',
    ['Detox', 'Antioxidante', 'Quimioprotección'],
    ['detox', 'antioxidante'],
    [
      { id: 'nac', tipo: 'potenciador', desc: 'Producción de glutatión', nivel: 'alto' },
      { id: 'curcuma', tipo: 'complementario', desc: 'Activación Nrf2', nivel: 'alto' }
    ],
    { dosis: '30-60mg/día' }
  ),

  'dim': createIngredient('dim', 'DIM (Diindolilmetano)', 'extractos',
    'Metabolito del indol-3-carbinol para balance hormonal.',
    'Metabolismo de estrógenos, balance hormonal.',
    ['Balance hormonal', 'Prevención cáncer', 'Acné'],
    ['hormonal'],
    [
      { id: 'magnesio', tipo: 'complementario', desc: 'Metabolismo', nivel: 'medio' },
      { id: 'vitamina_b6', tipo: 'cofactor', desc: 'Metabolismo hormonal', nivel: 'medio' }
    ],
    { dosis: '100-200mg/día' }
  ),

  'ic3': createIngredient('ic3', 'Indol-3-Carbinol (I3C)', 'extractos',
    'Precursor de DIM para metabolismo estrogénico.',
    'Modulación de estrógenos, apoyo hepático.',
    ['Balance hormonal', 'Hígado', 'Antioxidante'],
    ['hormonal', 'detox'],
    [
      { id: 'dim', tipo: 'complementario', desc: 'Metabolito relacionado', nivel: 'alto' },
      { id: 'nac', tipo: 'potenciador', desc: 'Detoxificación hepática', nivel: 'medio' }
    ],
    { dosis: '200-400mg/día' }
  ),

  'saw_palmetto': createIngredient('saw_palmetto', 'Saw Palmetto (Serenoa repens)', 'plantas',
    'Palma enana americana para próstata.',
    'Inhibidor 5-alfa reductasa, antiinflamatorio prostático.',
    ['Próstata', 'Testosterona', 'Cabello'],
    ['prostata', 'hormonal'],
    [
      { id: 'zinc', tipo: 'potenciador', desc: 'Salud prostática', nivel: 'alto' },
      { id: 'licopeno', tipo: 'complementario', desc: 'Próstata', nivel: 'alto' }
    ],
    { dosis: '320-640mg/día' }
  ),

  'ortiga': createIngredient('ortiga', 'Ortiga (Urtica dioica)', 'plantas',
    'Planta para próstata y alergias.',
    'Antiinflamatoria, antihistamínica natural.',
    ['Próstata', 'Alergias', 'Articulaciones'],
    ['prostata', 'articula'],
    [
      { id: 'saw_palmetto', tipo: 'complementario', desc: 'Próstata', nivel: 'alto' },
      { id: 'quercetina', tipo: 'potenciador', desc: 'Antihistamínico', nivel: 'medio' }
    ],
    { dosis: '300-600mg/día' }
  ),

  'butcher_broom': createIngredient('butcher_broom', 'Butcher Broom (Ruscus aculeatus)', 'plantas',
    'Planta para circulación venosa.',
    'Vasoconstrictor natural, anti-edema.',
    ['Circulación', 'Hemorroides', 'Piernas hinchadas'],
    ['circulacion'],
    [
      { id: 'castano_de_indias', tipo: 'potenciador', desc: 'Circulación venosa', nivel: 'alto' },
      { id: 'diosmina', tipo: 'complementario', desc: 'Tono venoso', nivel: 'alto' }
    ],
    { dosis: '150-300mg/día' }
  ),

  'castano_de_indias': createIngredient('castano_de_indias', 'Castaño de Indias', 'plantas',
    'Planta para insuficiencia venosa.',
    'Aescina, reduce permeabilidad capilar.',
    ['Circulación', 'Hemorroides', 'Edema'],
    ['circulacion'],
    [
      { id: 'butcher_broom', tipo: 'potenciador', desc: 'Circulación venosa', nivel: 'alto' },
      { id: 'rutina', tipo: 'potenciador', desc: 'Fortalecimiento capilar', nivel: 'alto' }
    ],
    { dosis: '300-600mg/día' }
  ),

  'centella_asiatica': createIngredient('centella_asiatica', 'Centella Asiática (Gotu Kola)', 'plantas',
    'Planta para piel y cognición.',
    'Triterpenoides, síntesis de colágeno y neuronal.',
    ['Piel', 'Cognición', 'Cicatrización', 'Estrés'],
    ['piel', 'cerebro'],
    [
      { id: 'colageno', tipo: 'potenciador', desc: 'Síntesis de colágeno', nivel: 'alto' },
      { id: 'ginkgo', tipo: 'complementario', desc: 'Circulación cerebral', nivel: 'medio' }
    ],
    { dosis: '500-1000mg/día' }
  ),

  'bacopa': createIngredient('bacopa', 'Bacopa (Bacopa monnieri)', 'plantas',
    'Hierba ayurvédica para memoria.',
    'Bacósidos A y B, neuroprotección.',
    ['Memoria', 'Cognición', 'Aprendizaje'],
    ['cerebro', 'memoria'],
    [
      { id: 'ginkgo', tipo: 'potenciador', desc: 'Circulación cerebral', nivel: 'alto' },
      { id: 'omega_3', tipo: 'complementario', desc: 'Neuroprotección', nivel: 'alto' }
    ],
    { dosis: '300-450mg/día' }
  ),

  'vinpocetina': createIngredient('vinpocetina', 'Vinpocetina', 'extractos',
    'Derivado de la vincamina para cognición.',
    'Vasodilatador cerebral, mejora flujo sanguíneo.',
    ['Memoria', 'Circulación cerebral', 'Audición'],
    ['cerebro', 'memoria'],
    [
      { id: 'ginkgo', tipo: 'potenciador', desc: 'Circulación cerebral', nivel: 'alto' },
      { id: 'omega_3', tipo: 'complementario', desc: 'Neuroprotección', nivel: 'alto' }
  ...
  'fosfatidilserina': createIngredient('fosfatidilserina', 'Fosfatidilserina (PS)', 'fosfolipidos',
    'Fosfolípido para función cognitiva.',
    'Componente neuronal, fluidez de membranas.',
    ['Memoria', 'Cognición', 'Concentración'],
    ['cerebro', 'memoria'],
    [
      { id: 'omega_3', tipo: 'potenciador', desc: 'Membranas neuronales', nivel: 'alto' },
      { id: 'ginkgo', tipo: 'complementario', desc: 'Flujo cerebral', nivel: 'medio' }
    ],
    { dosis: '100-300mg/día' }
  ),

  'citicolina': createIngredient('citicolina', 'Citicolina (CDP-Colina)', 'nootropicos',
    'Neuroprotector y cognitivo.',
    'Precursor de fosfatidilcolina, acetilcolina.',
    ['Cognición', 'Memoria', 'Recuperación neuronal'],
    ['cerebro', 'memoria'],
    [
      { id: 'fosfatidilserina', tipo: 'potenciador', desc: 'Membranas neuronales', nivel: 'alto' },
      { id: 'omega_3', tipo: 'complementario', desc: 'Neuroprotección', nivel: 'alto' }
    ],
    { dosis: '250-500mg/día' }
  ),

  'alfa_gpc': createIngredient('alfa_gpc', 'Alfa-GPC', 'nootropicos',
    'Colinérgico para memoria y foco.',
    'Precursor de acetilcolina, 40% colina.',
    ['Memoria', 'Foco', 'Rendimiento cognitivo'],
    ['cerebro', 'memoria'],
    [
      { id: 'huperzina_a', tipo: 'potenciador', desc: 'Inhibidor acetilcolinesterasa', nivel: 'alto' },
      { id: 'omega_3', tipo: 'complementario', desc: 'Neuroprotección', nivel: 'alto' }
    ],
    { dosis: '300-1200mg/día' }
  ),

  'lions_mane': createIngredient('lions_mane', 'Melena de León (Hericium erinaceus)', 'hongos',
    'Hongo nootrópico para nervios y cognición.',
    'Hericenonas y erinacinas, factor de crecimiento nervioso.',
    ['Nervios', 'Cognición', 'Memoria', 'Neuroprotección'],
    ['cerebro', 'nervios'],
    [
      { id: 'omega_3', tipo: 'potenciador', desc: 'Neuroprotección', nivel: 'alto' },
      { id: 'bacopa', tipo: 'complementario', desc: 'Memoria', nivel: 'alto' }
    ],
    { dosis: '500-2000mg/día' }
  ),

  'levadura_de_arroz_rojo': createIngredient('levadura_de_arroz_rojo', 'Levadura de Arroz Rojo', 'extractos',
    'Natural para colesterol.',
    'Monacolina K, inhibidor de HMG-CoA natural.',
    ['Colesterol', 'Corazón', 'Lípidos'],
    ['corazon', 'metabolismo'],
    [
      { id: 'coenzima_q10', tipo: 'potenciador', desc: 'Producción de CoQ10', nivel: 'alto' },
      { id: 'omega_3', tipo: 'complementario', desc: 'Perfil lipídico', nivel: 'alto' }
    ],
    { dosis: '1200-2400mg/día', contraindicaciones: [
      { condicion: 'estatinas', nivel: 'contraindicado', desc: 'No combinar con estatinas' }
    ]}
  ),

  'policosanol': createIngredient('policosanol', 'Policosanol', 'extractos',
    'Cera de caña de azúcar para colesterol.',
    'Mezcla de alcoholes alifáticos, inhibe síntesis colesterol.',
    ['Colesterol', 'LDL', 'Triglicéridos'],
    ['corazon', 'metabolismo'],
    [
      { id: 'levadura_de_arroz_rojo', tipo: 'complementario', desc: 'Mecanismos complementarios', nivel: 'alto' },
      { id: 'omega_3', tipo: 'potenciador', desc: 'Triglicéridos', nivel: 'alto' }
    ],
    { dosis: '5-20mg/día' }
  ),

  'berbamina': createIngredient('berbamina', 'Berbamina', 'extractos',
    'Alcaloide para presión arterial.',
    'Bloqueador de canales de calcio natural.',
    ['Presión arterial', 'Antiinflamatorio'],
    ['corazon', 'antiinflamatorio'],
    [
      { id: 'aceituna', tipo: 'potenciador', desc: 'Presión arterial', nivel: 'alto' },
      { id: 'ajo', tipo: 'complementario', desc: 'Presión y colesterol', nivel: 'alto' }
    ],
    { dosis: '100-300mg/día' }
  ),

  'ajo': createIngredient('ajo', 'Ajo (Allium sativum)', 'plantas',
    'Antibiótico natural y cardiovascular.',
    'Allicina, antimicrobiano y cardioprotector.',
    ['Inmunidad', 'Presión arterial', 'Colesterol'],
    ['inmunidad', 'corazon'],
    [
      { id: 'omega_3', tipo: 'potenciador', desc: 'Salud cardiovascular', nivel: 'alto' },
      { id: 'vitamina_c', tipo: 'complementario', desc: 'Inmunidad', nivel: 'medio' }
    ],
    { dosis: '600-1200mg/día' }
  ),

  'canela': createIngredient('canela', 'Canela (Cinnamomum)', 'plantas',
    'Especia para control de glucosa.',
    'Polifenoles mejoran sensibilidad a insulina.',
    ['Glucosa', 'Insulina', 'Antioxidante'],
    ['metabolismo', 'antioxidante'],
    [
      { id: 'berberina', tipo: 'potenciador', desc: 'Control de glucosa', nivel: 'alto' },
      { id: 'cromo', tipo: 'complementario', desc: 'Metabolismo glucosa', nivel: 'alto' }
    ],
    { dosis: '500-2000mg/día' }
  ),

  'gymnema': createIngredient('gymnema', 'Gymnema sylvestre', 'plantas',
    'Planta india para diabetes.',
    'Ácido gymnémico, reduce absorción de azúcar.',
    ['Diabetes', 'Glucosa', 'Apetito'],
    ['metabolismo'],
    [
      { id: 'berberina', tipo: 'potenciador', desc: 'Control de glucosa', nivel: 'alto' },
      { id: 'canela', tipo: 'complementario', desc: 'Sensibilidad insulina', nivel: 'alto' }
    ],
    { dosis: '400-600mg/día' }
  ),

  'banaba': createIngredient('banaba', 'Banaba (Lagerstroemia)', 'plantas',
    'Planta filipina para glucosa.',
    'Ácido corosólico, similar a insulina.',
    ['Glucosa', 'Diabetes', 'Peso'],
    ['metabolismo'],
    [
      { id: 'berberina', tipo: 'potenciador', desc: 'Control de glucosa', nivel: 'alto' },
      { id: 'gymnema', tipo: 'complementario', desc: 'Absorción de azúcar', nivel: 'alto' }
    ],
    { dosis: '48-96mg/día' }
  ),

  'cafe verde': createIngredient('cafe_verde', 'Extracto de Café Verde', 'extractos',
    'Contiene ácido clorogénico para metabolismo.',
    'Inhibidor de glucosa-6-fosfatasa, termogénico.',
    ['Metabolismo', 'Glucosa', 'Antioxidante'],
    ['metabolismo', 'antioxidante'],
    [
      { id: 'canela', tipo: 'complementario', desc: 'Glucosa', nivel: 'medio' },
      { id: 'te_verde', tipo: 'potenciador', desc: 'Termogénico', nivel: 'alto' }
    ],
    { dosis: '400-800mg/día' }
  ),

  'te_verde': createIngredient('te_verde', 'Té Verde (Camellia sinensis)', 'plantas',
    'Rico en catequinas para metabolismo.',
    'EGCG, termogénico y antioxidante.',
    ['Metabolismo', 'Antioxidante', 'Cerebro'],
    ['metabolismo', 'antioxidante', 'cerebro'],
    [
      { id: 'cafe_verde', tipo: 'potenciador', desc: 'Termogénico', nivel: 'alto' },
      { id: 'l-teanina', tipo: 'complementario', desc: 'Foco sin ansiedad', nivel: 'alto' }
    ],
    { dosis: '250-500mg EGCG/día' }
  ),

  'garcinia_cambogia': createIngredient('garcinia_cambogia', 'Garcinia Cambogia', 'plantas',
    'Fruta para supresión de apetito.',
    'Ácido hidroxicítrico, inhibe lipogénesis.',
    ['Apetito', 'Peso', 'Metabolismo'],
    ['metabolismo'],
    [
      { id: 'te_verde', tipo: 'complementario', desc: 'Termogénico', nivel: 'medio' },
      { id: 'cafe_verde', tipo: 'complementario', desc: 'Metabolismo', nivel: 'medio' }
    ],
    { dosis: '1500-3000mg/día' }
  ),

  'forskolina': createIngredient('forskolina', 'Forskolina (Coleus forskohlii)', 'plantas',
    'Activador directo de adenilato ciclasa.',
    'Aumenta AMPc, moviliza grasas.',
    ['Metabolismo', 'Lipólisis', 'Tiroides'],
    ['metabolismo'],
    [
      { id: 'te_verde', tipo: 'potenciador', desc: 'Termogénico', nivel: 'alto' },
      { id: 'yohimbina', tipo: 'complementario', desc: 'Lipólisis', nivel: 'medio' }
    ],
    { dosis: '50-250mg/día' }
  ),

  'yohimbina': createIngredient('yohimbina', 'Yohimbina', 'extractos',
    'Alcaloide para quema de grasa.',
    'Antagonista alfa-2 adrenérgico, moviliza grasa.',
    ['Quema de grasa', 'Rendimiento', 'Libido'],
    ['metabolismo', 'energia'],
    [
      { id: 'cafeina', tipo: 'potenciador', desc: 'Termogénico', nivel: 'alto' },
      { id: 'forkskolina', tipo: 'complementario', desc: 'Lipólisis', nivel: 'medio' }
    ],
    { dosis: '5-10mg/día', contraindicaciones: [
      { condicion: 'corazon', nivel: 'precaución', desc: 'Consultar médico' }
    ]}
  ),
